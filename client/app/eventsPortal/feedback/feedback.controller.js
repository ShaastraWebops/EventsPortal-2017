...
.factory('Excel',function($window){
  ...
  .controller('TotalFeedbackCtrl', function ($scope, EventsPortalService, $state, $http, $mdDialog, Auth, $stateParams, Excel, $timeout, $mdToast, FileSaver, Blob) {
    
    $http.get('/api/feedbacks')
    	.then(function (response) {
    		$scope.totalFeedback = response.data;
    	});
      ...
      $scope.exportData = function () {
        ...
        FileSaver.saveAs(blob, "feedback.xls");
      };
